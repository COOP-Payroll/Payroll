...
const errorConverter = (err, req, res, next) => {
    ...
    if (!(error instanceof api_error_1.default)) {
        ...
        error = new api_error_1.default(statusCode, message, false, err.stack);
    }
    next(error);
};
...
const errorHandler = (err, req, res, next) => {
    ...
    const response = Object.assign({ code: statusCode, message,
        details }, (config_1.default.env === "development" && { stack: err.stack }));
